...
def run_training(args: TrainArgs,
    ...
    train_data_save = train_data.batch_graph()
    # print(train_data_save[0].mol_graphs[0].targets)
    data_name = f"{args.data_path.split('/')[-2].split('.')[0]}.pt"
    print(data_name)
    torch.save(train_data_save,data_name)
    exit()
    # Create data loaders
