...
class GOODRDB7(InMemoryDataset):
    r"""
    The GOOD-RDB7 dataset. Adapted from 
    `High accuracy barrier heights, enthalpies, and rate coefficients for chemical reactions.`_.
    ...
    def process(self):
        ...
        dataset = torch.load("/apdcephfs/share_1364275/yandrewchen/GOOD/datasets/barriers_rdb7.pt")[0].mol_graphs
